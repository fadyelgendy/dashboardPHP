...
if(isset($_POST['submit'])){
    ...
    $id = $project['id'];
    try {
        $sql = 'UPDATE projects SET title = :title, img_title = :img_title, img_title = :description WHERE id = :id';
        $stmt = $pdo->prepare($sql);
        ...
        <div class="col">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="description" id="description" class="form-control"><?php echo $project['description'];?></textarea>
                </div>
                <div class="form-group">
