<?php
$page_title = 'Add New Manage Posts';
...
if(isset($_POST['submit'])){
    ...
    try {
        $sql = 'INSERT INTO manage_posts (title, img_title, description) VALUES (:title, :img_title, :description)';
        $stmt = $pdo->prepare($sql);
        $stmt->execute(['title' => $title,'img_title' => $img_title, 'description' => $description]);
        header("location: ../pages/manage_posts");
