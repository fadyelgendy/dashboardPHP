              ...
              <tr>
                ...
                <?php foreach($pPosts as $post) { ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-light border" href=" models/edit_model?name=manage_posts&id=<?php echo $post['id'];?>">
                      <i class="fa fa-pencil"></i> Edit</a>
                      <a class="btn btn-danger" href=" models/delete_model?name=manage_posts&id=<?php echo $post['id'];?>"> <i class="fa fa-times"></i> Delete</a>
                    </td>
                  </tr>
                <?php }?>
<!--                  end foreach -->
